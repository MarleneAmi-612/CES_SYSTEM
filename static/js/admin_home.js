// admin_home.js — menú de usuario + modales (logout, perfil, cambio password, alta admin)
(function () {
    ...
    if (addUserForm) {
      addUserForm.addEventListener("submit", function(e){
        ...
        submitForm(addUserForm, document.getElementById("auMsg"), function(){
          ...
          addUserForm.reset();
          document.getElementById("auMsg").className = "form-msg ok";
          document.getElementById("auMsg").textContent = "Usuario creado con éxito.";
        });
      });
    }
